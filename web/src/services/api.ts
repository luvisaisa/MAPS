...
class APIClient {
  ...
  async getPYLIDCScans(params?: PaginationParams & {
    ...
    min_subtlety?: number;
    max_subtlety?: number;
    min_malignancy?: number;
    max_malignancy?: number;
    min_sphericity?: number;
    max_sphericity?: number;
    min_margin?: number;
    max_margin?: number;
    min_lobulation?: number;
    max_lobulation?: number;
    min_spiculation?: number;
    max_spiculation?: number;
    min_texture?: number;
    max_texture?: number;
